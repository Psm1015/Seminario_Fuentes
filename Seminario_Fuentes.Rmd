...
Una vez se han analizado todos los datos, llegamos a la conclusión de que la obseidad es una enfermedad muy compleja ya que es afectada por muchos factores. Entre estos destaca que la edad, el nivel de estudios y el género tienen una correlación directa, ya que en términos generales la mayor parte de personas que la padecen son de la tercera edad, tienen un nivel de estudios bajo y es ligeramente más frecuente en hombres.
